...
public class Dosimeter implements CustomItem {
	...
	public static final @NotNull NamespacedKey DOSIMETER = new NamespacedKey(MSItems.getInstance(), "dosimeter");

	public Dosimeter() {
		this.namespacedKey = new NamespacedKey(MSItems.getInstance(), "dosimeter");
