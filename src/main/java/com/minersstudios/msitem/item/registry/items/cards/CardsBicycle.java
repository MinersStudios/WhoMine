...
public interface CardsBicycle {
    ...
    class Blue1 extends CustomItemImpl implements CardsBicycle {
    ...
    class Blue2 extends CustomItemImpl implements CardsBicycle {
        private static final String KEY;
        private static final ItemStack ITEM_STACK;
    ...
    class Red1 extends CustomItemImpl implements CardsBicycle {
        private static final String KEY;
        private static final ItemStack ITEM_STACK;
    ...
    class Red2 extends CustomItemImpl implements CardsBicycle {
        private static final String KEY;
        private static final ItemStack ITEM_STACK;
