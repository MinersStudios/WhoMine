...
public final class SpruceChair extends CustomDecorDataImpl<SpruceChair> {
    ...
    protected @NotNull Builder builder() {
        ...
        itemMeta.setCustomModelData(1014);
        itemMeta.displayName(ChatUtils.createDefaultStyledText("Еловый стул со спинкой"));
