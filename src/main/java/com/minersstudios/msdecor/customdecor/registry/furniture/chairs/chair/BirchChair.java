...
public final class BirchChair extends CustomDecorDataImpl<BirchChair> {
    ...
    protected @NotNull Builder builder() {
        ...
        itemMeta.setCustomModelData(1009);
        itemMeta.displayName(ChatUtils.createDefaultStyledText("Берёзовый стул со спинкой"));
        ...
        return new Builder()
                ...
                .recipes(
                        builder -> Map.entry(
                                ...
                                .ingredients(
                                        ShapedRecipeBuilder.material('P', Material.BIRCH_PLANKS),
