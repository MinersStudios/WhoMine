...
public final class OakChair extends CustomDecorDataImpl<OakChair> {
    ...
    protected @NotNull Builder builder() {
        ...
        itemMeta.setCustomModelData(1013);
        itemMeta.displayName(ChatUtils.createDefaultStyledText("Дубовый стул со спинкой"));
        ...
        return new Builder()
                ...
                .recipes(
                        builder -> Map.entry(
                                ...
                                .ingredients(
                                        ShapedRecipeBuilder.material('P', Material.OAK_PLANKS),
