...
public class CherryNightstand implements Wrenchable {
    ...
    public CherryNightstand() {
        this.namespacedKey = new NamespacedKey(MSDecor.getInstance(), "cherry_nightstand");
    ...
    public @Nullable List<Recipe> initRecipes() {
        ...
        return this.recipes = Collections.singletonList(shapedRecipe);
    }
    ...
    public enum Type implements Typed.Type {
        ...
        Type(int customModelData) {
            this.namespacedKey = new NamespacedKey(MSDecor.getInstance(), this.name().toLowerCase(Locale.ROOT) + "_cherry_nightstand");
            this.itemName = "Вишнёвая тумбочка";
