...
import com.minersstudios.mscustoms.registry.item.Dosimeter;
...
@EventListener
public final class DosimeterMechanic extends AbstractEventListener<MSCustoms> {
    ...
    public static class DosimeterTask {
        ...
        public DosimeterTask(final @NotNull MSCustoms plugin) {
