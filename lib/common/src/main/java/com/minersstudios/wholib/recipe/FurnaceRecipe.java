...
public class FurnaceRecipe extends AbstractCookingRecipe<FurnaceRecipe> {
    ...
    @Contract("_, _ -> new")
    public static @NotNull FurnaceRecipe of(
            final @NotNull ResourceKey path,
            final @NotNull Object result
    ) {
    ...
    public static @NotNull FurnaceRecipe of(
        ...
        return new FurnaceRecipe(path, result, category, group);
    }
}
