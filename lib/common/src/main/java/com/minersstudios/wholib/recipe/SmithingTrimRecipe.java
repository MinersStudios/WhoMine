...
public class SmithingTrimRecipe extends AbstractSmithingRecipe {
    ...
    public static  @NotNull SmithingTrimRecipe of(
            final @NotNull ResourceKey path,
            final @NotNull Object result,
            final @NotNull RecipeChoice<?> template,
            final @NotNull RecipeChoice<?> base,
    ...
    public static  @NotNull SmithingTrimRecipe of(
        ...
        return new SmithingTrimRecipe(path, result, template, base, addition, copyDataComponents);
    }
}
