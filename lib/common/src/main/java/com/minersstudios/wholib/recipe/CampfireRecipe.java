...
public class CampfireRecipe extends AbstractCookingRecipe<CampfireRecipe> {
    ...
    @Contract("_, _ -> new")
    public static @NotNull CampfireRecipe of(
            final @NotNull ResourceKey path,
            final @NotNull Object result
    ) {
    ...
    public static @NotNull CampfireRecipe of(
        ...
        return new CampfireRecipe(path, result, category, group);
    }
}
